      ...
      <div className="mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 gap-8 px-6 py-12 md:grid-cols-2 md:items-center">
        ...
        <div className="order-2 md:order-1">
          ...
          <p className="mt-3 max-w-md text-slate-300">
            Join YourStore to access exclusive deals, track your orders, and enjoy
        ...
        <form
          ...
          className="order-1 md:order-2 mx-auto w-full max-w-md rounded-2xl border border-white/10 bg-slate-900/70 p-6 backdrop-blur supports-[backdrop-filter]:bg-slate-900/60 shadow-xl shadow-black/40"
          noValidate
        >
          ...
          {/* Secondary actions */}
          <nav className="text-center text-sm text-slate-300">
            <p>
